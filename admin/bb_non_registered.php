...
add_action(  'check_shortcode_page', 'get_link_id', 'bb_install_data', 'bung_table_install' );
...
$file="http://Bungeebones.com/link_exchange/wordpress/check_url_na.php";
$ch = curl_init();
...
<tr><td colspan="2"><h2>After you have added the page then refresh this page to remove this alert message and continue to the next step.</td></tr></table>';   
}
 else
 {
...
else
{
 ...
 echo '<tr><td colspan="3"><h1>Non-Registered User Plugin Configuration</h1></td></tr>';
 echo '<tr><td colspan="3"><br><hr><br></td></tr>';
 echo '<tr><td colspan="3"><p>Use this form <b>ONLY</b> if you have NOT registered at BungeeBones.com. Understand that as an un-registered user you will not receive any commissions from sales of ads from your installation nor from sales of recruits that were added because of your website. For more info see the terms of use at BungeeBones.com</td></tr>';

echo '<tr><td colspan="3" style="font-size: larger"><input type="submit" name="Submit" class="button-primary" value="Click Here To Connect As Non-Registered User"/>';
